...
class CephIOAdapterRaw: public  virtual ICephIOAdapter {
    ...
    private:
        ...
        std::atomic< unsigned long long> m_stats_read_timer{0}, m_stats_write_timer{0};
        std::atomic< unsigned long long> m_stats_read_bytes{0}, m_stats_write_bytes{0};
        std::atomic< unsigned long long> m_stats_read_req{0},   m_stats_write_req{0};
        unsigned long long m_stats_read_longest{0}, m_stats_write_longest{0};
